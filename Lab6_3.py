...
# 3. Validation using AprilTag tracking
...
def main():
    ...
    while True:
        ...
        # YOUR CODE HERE
        color_frame, _ = camera.get_frames()  # Replace with actual frame
        ...
        if len(tags) > 0:
            ...
            # YOUR CODE HERE
            rot_matrix = detector.get_tag_pose(tag.corners, intrinsics, TAG_SIZE)  # Replace with actual rotation
            trans_vector = detector.get_tag_pose(tag.corners, intrinsics, TAG_SIZE)  # Replace with actual translation
            ...
            if rot_matrix is not None and trans_vector is not None:
                ...
                # Hint: Multiply T_cam_to_robot @ pos_camera_hom
                # YOUR CODE HERE
                T_tag_to_robot = T_cam_to_robot @ T_tag_to_cam  # Replace with homogeneous coordinates (4x1)
                ...
                # YOUR CODE HERE
                distance = np.linalg.norm(pos_camera)  # Replace with distance
                
                # TODO: Draw detection on image
                # Hint: Use detector.draw_tags(color_frame, tag)
                # YOUR CODE HERE
                color_frame = detector.draw_tags(color_frame, tag) # Replace with drawn frame
                ...
                if counter % PRINT_INTERVAL == 0:
                    ...
                    # YOUR CODE HERE
                    print(f"  x: {pos_camera[0]:.2f}, y: {pos_camera[1]:.2f}, z: {pos_camera[2]:.2f}")

                    print("\nRobot Frame (mm):")
                    # TODO: Print 3D positions in Robot Frame
                    # YOUR CODE HERE
                    print(f"  x: {pos_robot[0]:.2f}, y: {pos_robot[1]:.2f}, z: {pos_robot[2]:.2f}")

...
# Lab Assignment 6: Robot-Camera Calibration via April-Tags and 3D Point Registration
# 2. Robot-camera calibration using point set registration
...
def main():
    ...
    # YOUR CODE HERE
    intrinsics = camera.get_intrinsics()  # Replace with actual call to get intrinsics
        ...
        if key == ord('c'):  # User pressed 'c' to capture
            ...
            if len(tags) == num_tags:
                ...
                for tag in tags_sorted:
                    ...
                    # YOUR CODE HERE
                    temp_measurements.append(trans_vector.reshape(3))
    ...
    # TODO: Call point_registration() to compute transformation
    # YOUR CODE HERE
    T_cam_to_robot = point_registration(points_camera, points_robot)  # Replace with actual transformation
    
    print("\nTransformation matrix (camera to robot):")
    print(T_cam_to_robot)
    
    # TODO: Extract rotation and translation for display
    # YOUR CODE HERE
    R = T_cam_to_robot[:3, :3]  # Replace with actual rotation
    t = T_cam_to_robot[:3, 3]   # Replace with actual translation
    ...
    # TODO: Transform camera points to robot frame using T_cam_to_robot
    ...
    # YOUR CODE HERE
    points_camera_hom = np.vstack([points_camera, np.ones((1, num_tags))])  # Replace with homogeneous coordinates
    points_camera_transformed_hom = T_cam_to_robot @ points_camera_hom     # Replace with transformed points
    points_camera_transformed = points_camera_transformed_hom[:3, :]
    
    # TODO: Calculate errors between transformed camera points and robot points
    # Hint: Compute differences, then use np.linalg.norm() on each column
    # YOUR CODE HERE
    errors = points_robot - points_camera_transformed  # Replace with error vectors
